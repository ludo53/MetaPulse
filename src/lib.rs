...
#[derive(Debug)]
pub struct MetaPulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaPulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaPulse processing");
    
    let mut processor = MetaPulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaPulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaPulseProcessor::new(false);
